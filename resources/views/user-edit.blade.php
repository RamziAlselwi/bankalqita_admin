                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="name">{{ __('أسم المستخدم')}}<span class="text-red">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="email">{{ __('البريد الالكتروني')}}<span class="text-red">*</span></label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('role', $roles, $user_role->id??'' ,[ 'class'=>'form-control select2', 'placeholder' => 'حدد الدور','id'=> 'role', 'required'=>'required']) !!}
                                    </div>
                                    <div class="form-group">
                                        <label for="role">{{ __('أذونات')}}</label>
