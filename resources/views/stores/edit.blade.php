                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ clean($store->email, 'email')}}" placeholder="ادخل البريد الألكتروني" required>
                                        <div class="help-block with-errors"></div>
