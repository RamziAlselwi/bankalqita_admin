...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><h3>{{ __('إضافة الإذن')}}</h3></div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="permission">{{ __('إذن')}}<span class="text-red">*</span></label>
                                        <input type="text" class="form-control" id="permission" name="name" placeholder="Permission Name" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail3">{{ __('معين إلى الدور')}} </label>
